...
sair.addEventListener('click', () => {
    localStorage.clear();
    window.location.href = '/autofix.site/index.html';
});

// Redireciona para a página do carrinho
carrinho.addEventListener('click', () => {
    window.location.href = '/autofix.site/carrinho.html';
});
...
function srcIMG(idCategoria) {
    const categorias = {
        1: '/autofix.site/images/Pneu.jpeg',
        2: '/autofix.site/images/Roda.jpeg',
        3: '/autofix.site/images/Som.jpeg'
    };
    return categorias[idCategoria] || '/autofix.site/images/default.jpg';
}
